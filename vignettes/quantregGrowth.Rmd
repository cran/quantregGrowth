---
title: "quantregGrowth: nonparametric quantile regression for additive and semiparametric models with focus on growth charts"
...
output: 
  html_document:
    toc: true
    number_sections: false #se vuoi mettere true, allora sotto i titoli delle sezioni devi metterci ==== (vedi qgam)
vignette: >
...
It is also possible to fit multiple quantile curves and to display to results accordingly
...
Note in the left plot, each symbol refers to a specific quantile curve.
